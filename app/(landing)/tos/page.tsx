...
export default function TermsOfServicePage() {
    return (
        <div className="max-w-4xl mx-auto px-4 py-8 prose prose-slate dark:prose-invert">
            ...
            <p>
                Audit Gen provides a diagnostic tool that connects to your QuickBooks Online (QBO) account(s) to analyze financial data, identify potential discrepancies or risks ("Issues"), and generate reports and health scores. The Service offers both limited free features and premium features accessible via subscription.
            </p>
            ...
            <ul>
                <li><strong>QBO Connection:</strong> To use the core diagnostic features, you must connect your QBO account. This connection is facilitated via secure OAuth 2.0 protocols provided by Intuit.</li>
                <li><strong>Authorization Scope:</strong> Your authorization permits the Service to access specific data types within your QBO company file as detailed in our Data Authorization Policy. This includes financial records, customer/vendor information, and company metadata.</li>
                ...
                <li><strong>Ownership:</strong> You retain ownership of all data within your QBO account. Our access is limited to the scope granted by you and governed by this agreement and our Data Authorization Policy.</li>
                <li><strong>Revocation:</strong> You can revoke the Service's access to your QBO account at any time by disconnecting the connection within the Service or via your QBO account settings.</li>
            </ul>
            ...
            <ul>
                ...
                <li><strong>Acceptable Use:</strong> You agree not to misuse the Service or help anyone else do so. This includes, but is not limited to:
                    <ul>
                        ...
                        <li>Violating the QBO Acceptable Use Policy or API Terms.</li>
            ...
            <ul>
                <li><strong>Your Data:</strong> As stated in our Data Authorization Policy, your financial data retrieved from QBO remains yours. We access it only as authorized.</li>
